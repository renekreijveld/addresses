...
namespace Joomla\Component\Addresses\Administrator\Table;
...
class AddressTable extends Table
{
    ...
    {
        parent::__construct('#__addresses', 'id', $db);
    }
    ...
    {
        $k = $this->_tbl_key;
        return 'com_addresses.address.' . (int) $this->$k;
    }
    ...
    protected function _getAssetParentId(Table $table = null, $id = null): int
    {
        ...
        $assetParent->loadByName('com_addresses');
