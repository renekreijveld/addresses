...
namespace Joomla\Component\Addresses\Administrator\Helper;
...
class AddressesHelper
{
	...
	public static function addSubmenu($name = '')
	{
		\JHtmlSidebar::addEntry(
			Text::_('COM_ADDRESSES_TITLE_ADDRESSES'),
			'index.php?option=com_addresses&view=addresses',
			$name === 'addresses'
		);
	}
